...
import { getDfa2MinDfaTransTable, convertDFAToMinDFA } from '../../tools/2/convertDFAToMinDFA';
import { getNfa2DfaTransTable, convertNFAToDFA } from '../../tools/2/convertNFAToDFA';
